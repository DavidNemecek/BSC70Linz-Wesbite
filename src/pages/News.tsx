    ...
    <div className="bg-night min-h-screen pt-[72px]">
      <div ref={containerRef} className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10 py-12 lg:py-20">
        ...
        <div data-animate className="mb-12 opacity-0">
          ...
          <p className="mt-4 text-base text-white/60 max-w-[600px]">
        ...
        {featuredNews && (
          <div data-animate className="mb-12 opacity-0">
            <div className="bg-charcoal rounded-xl border border-white/[0.08] p-6 sm:p-10">
              ...
              <div className="flex items-center gap-3 text-sm text-white/50 mb-4">
                ...
                <span className="text-ember">{featuredNews.category}</span>
              </div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-white mb-4 leading-tight">
                {featuredNews.title}
              </h2>
              <p className="text-base text-white/60 leading-relaxed max-w-[800px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {regularNews.map((article) => (
            <article
              key={article.id}
              data-card
              className="bg-charcoal rounded-xl border border-white/[0.08] p-6 opacity-0 hover:-translate-y-1 hover:border-ember/30 transition-all duration-300"
            >
